...
//var_dump(ADMIN_PATH . '/includes/init.php');

//$s=str_replace(ADMIN_PATH . '/includes/init.php', '', str_replace('\\', '/', __FILE__));
define('ROOT_PATH',$s);
...
/* 验证管理员身份 */
if ((!isset($_SESSION['admin']['id']) || intval($_SESSION['admin']['id']) <= 0) )
{
	//ecs_header("Location: ../../admin.php");
}

...
if (!defined('INIT_NO_SMARTY'))
{
	...
	$smarty->template_dir   = ROOT_PATH . 'mobile/tpl';
	$smarty->cache_dir	  = ROOT_PATH . 'temp/caches';
	$smarty->compile_dir	= ROOT_PATH . 'temp/compiled/mobile1';
...
if(!empty($_SESSION["wx_auto_user"])){
	$GLOBALS['smarty']->assign('wx_auto_user', $_SESSION["wx_auto_user"]);
}

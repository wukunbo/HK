...
function insert_myregion()
{
$ip = IP_GetIP(); //本机测试 请将后面IP_GetIP();修改为你要测试的IP地址，如：'203.83.115.131';
//$IP_str = file_get_contents('http://int.dpool.sina.com.cn/iplookup/iplookup.php?ip='.$ip); 
$IP_tmp = explode("	", $IP_str);
$ip_region = iconv("GBK", "UTF-8", $IP_tmp[4]); //gbk编码网站请注释这一行
if($ip_region == '香港' || $ip_region == '台湾'){
$myregion = "<script type='text/javascript'>var zh_choose = 't';</script><script type='text/javascript' src='js/tw_cn.js'></script>";
}else{
$myregion = "<script type='text/javascript'>var zh_choose = 's';</script><script type='text/javascript' src='js/tw_cn.js'></script>";
}
return $myregion;
}
?>
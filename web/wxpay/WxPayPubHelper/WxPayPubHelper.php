...
class Common_util_pub
{
	...
	function postXmlSSLCurl_hongbao($xml,$url,$second=30)
	{
		$ch = curl_init();
		//超时时间
		curl_setopt($ch,CURLOPT_TIMEOUT,$second);
		...
		//使用证书：cert 与 key 分别属于两个.pem文件
		//默认格式为PEM，可以注释
		//curl_setopt($ch,CURLOPT_SSLCERTTYPE,'txt');
		curl_setopt($ch,CURLOPT_SSLCERT,WxPayConf_pub::SSLCERT_PATH);
		//默认格式为PEM，可以注释
		//curl_setopt($ch,CURLOPT_SSLKEYTYPE,'txt');
		curl_setopt($ch,CURLOPT_SSLKEY,WxPayConf_pub::SSLKEY_PATH);
		//post提交方式
		
		//curl_setopt($ch,CURLOPT_SSLKEY,"http://yun.tuolve.com/paobu/wxpay/WxPayPubHelper/cacert/apiclient_cert.txt");
		//curl_setopt($ch,CURLOPT_SSLKEY, WxPayConf_pub::SSLKEY_PATH);
		//curl_setopt($ch,CURLOPT_CAINFOTYPE,'txt');
    ...
    curl_setopt($ch,CURLOPT_CAINFO,dirname(__FILE__).DIRECTORY_SEPARATOR.'zhengshu'.DIRECTORY_SEPARATOR.'rootca.pem');
		*/
		//curl_setopt($ch,CURLOPT_SSLKEY, WxPayConf_pub::SSLCERT_PATH);
		//curl_setopt($ch,CURLOPT_SSLKEY, WxPayConf_pub::SSLKEY_PATH);

		//curl_setopt($ch,CURLOPT_CAINFO,WxPayConf_pub::CAINFO_PATH);
	/*	echo "---------------------";
		var_dump(WxPayConf_pub::SSLCERT_PATH);
		var_dump(WxPayConf_pub::SSLKEY_PATH);
		var_dump(WxPayConf_pub::CAINFO_PATH);
		var_dump(CURLOPT_SSLKEYTYPE);
		echo "---------------------";
		*/
		//post提交方式
		curl_setopt($ch,CURLOPT_POST, true);

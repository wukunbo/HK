<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\xampp\htdocs\HK\web/application/shop\view\index\goods_lists.html";i:1526548264;s:63:"D:\xampp\htdocs\HK\web\application\shop\view\Public\header.html";i:1526377370;s:60:"D:\xampp\htdocs\HK\web\application\shop\view\Public\nav.html";i:1526547439;}*/ ?>
<!-- 包含头部模版header -->
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="w48 float-l border-1p-ddd m-r-b border-shadow" style="margin-right: 5px;">
                <a href="<?php echo url('goods/detail',array('id'=>$vo['goods_id'])); ?>">
                    <div class="content_img">
                        <img src="http://192.168.1.215/HK/web/<?php echo $vo['img_orogin']; ?>"/>
                    </div>

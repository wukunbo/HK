<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\xampp\htdocs\HK\web/application/shop\view\Goods\detail.html";i:1526623836;s:63:"D:\xampp\htdocs\HK\web\application\shop\view\Public\header.html";i:1526612616;s:60:"D:\xampp\htdocs\HK\web\application\shop\view\Public\nav.html";i:1526547439;}*/ ?>
<!-- 包含头部模版header -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<script type="text/javascript">
  var con=0;
    ...
    <div id="con_xq_1">
        ...
        <div class="swiper-container swiper1">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img src="http://test.tuolve.com/HK/web/<?php echo $data['img_orogin']; ?>"/>
                </div>
        ...
        <div class="content_title">
            ...
            <div class="content_title_right">
                ...
                <div class="sc" onclick="add_collect(<?php echo $data['goods_id']; ?>)">
    ...
    <div class="row fixed-bottom row-center" style="padding:0;border-top: 1px solid #e0e0e0;background-color: #fff;">
        <div class="w20" onclick="add_collect(<?php echo $data['goods_id']; ?>)"><img class="shoucang" src="/HK/web/public/static/shop//img/shoucang.png"></div>
...
function add_collect(goods_id){
    ...
    var url="<?php echo url('User/add_collect'); ?>?ajax=1"

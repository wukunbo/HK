<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\xampp\htdocs\HK\web/application/shop\view\Index\cart.html";i:1526627366;s:63:"D:\xampp\htdocs\HK\web\application\shop\view\Public\header.html";i:1526612616;s:60:"D:\xampp\htdocs\HK\web\application\shop\view\Public\nav.html";i:1526547439;}*/ ?>
<!-- 包含头部模版header -->
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="content mtop_1">
        <div class="item item-thumbnail-left item-borderless">
            ...
            <div class="item_" style="margin-bottom: 50px;">
                ...
                <a href="<?php echo url('Index/del_cart'); ?>?&cart_id=<?php echo $vo[cart_id]; ?>"><img src="/HK/web/public/static/shop//img/delete.png" style="width: 15px;float: right;"></a>
            </div>
        </div>
...
function add_order(){
    ...
    window.location.href="<?php echo url('Order/add_order'); ?>?&cart_ids="+cart_ids;
}

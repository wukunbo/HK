<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:79:"D:\xampp\htdocs\HK\web/application/userweb\view\Config\material_cate_lists.html";i:1524649966;s:66:"D:\xampp\htdocs\HK\web\application\userweb\view\Public\layout.html";i:1524540430;s:66:"D:\xampp\htdocs\HK\web\application\userweb\view\Public\header.html";i:1524537495;s:66:"D:\xampp\htdocs\HK\web\application\userweb\view\Public\navbar.html";i:1524644679;s:64:"D:\xampp\htdocs\HK\web\application\userweb\view\Public\left.html";i:1524638402;s:64:"D:\xampp\htdocs\HK\web\application\userweb\view\Public\here.html";i:1524622127;s:66:"D:\xampp\htdocs\HK\web\application\userweb\view\Public\footer.html";i:1524540092;}*/ ?>
<!-- 包含头部模版header -->
<!DOCTYPE html>
<html>
<head>
...
<div class="panel panel-default">
            ...
            <tbody>
                <?php if(is_array($data[content]) || $data[content] instanceof \think\Collection || $data[content] instanceof \think\Paginator): $i = 0; $__LIST__ = $data[content];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                    <tr >
                        ...
                        <td><a href="<?php echo url('Config/material_cate_add'); ?>&id=<?php echo $vo['id']; ?>"><i class="fa fa-pencil"></i></a>
                            <a href="<?php echo url('Config/material_cate_del'); ?>&id=<?php echo $vo['id']; ?>" onclick="return del_sure();"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
    ...
    <div class="panel-footer">
        <a class="btn btn-primary" href="<?php echo url('Config/material_cate_add'); ?>" ><i class="fa fa-plus"></i>新增</a>

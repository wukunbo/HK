<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"D:\xampp\htdocs\HK\web/application/shop\view\User\index.html";i:1526627980;s:63:"D:\xampp\htdocs\HK\web\application\shop\view\Public\header.html";i:1526612616;s:63:"D:\xampp\htdocs\HK\web\application\shop\view\Public\footer.html";i:1526547461;}*/ ?>
<!-- 包含头部模版header -->
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="back-white">
    ...
    <div class="row text-center ion">
        ...
        <a class="col" href="<?php echo url('Order/order_lists'); ?>?&pay_status=0">
            <img src="/HK/web/public/static/shop//img/order.png"> <br/>
            未付款订单
        </a>
       
        <a class="col" href="<?php echo url('Order/order_lists'); ?>?&pay_status=1">
            <img src="/HK/web/public/static/shop//img/order.png"> <br/>
            已付款订单
        </a>

        <a class="col" href="<?php echo url('Order/order_lists'); ?>?&pay_status=1&shipping_status=1">
            <img src="/HK/web/public/static/shop//img/order.png"> <br/>
            已发货订单
        </a>
    ...
    <a class="item item-icon-right ion" href="<?php echo url('User/wish_lists'); ?>">
    ...
    <a class="item item-icon-right ion" href="<?php echo url('User/address_lists'); ?>">
